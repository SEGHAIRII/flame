...
def _build_hgrn_asr(job_config: JobConfig, metadata: dict) -> nn.Module:
    from sparse_mamba.custom_models.audio_models.hgrn import HGRNASRConfig, HGRNASRForCTC 
...
@register_asr_model("sparse_mamba2_delta_asr")
def _build_sparse_mamba2_delta_asr(job_config: JobConfig, metadata: dict) -> nn.Module:
    from sparse_mamba.custom_models.audio_models.delta_mamba2 import SparseMamba2DeltaASRConfig, SparseMamba2DeltaASRForCTC
    ...
    if config_path and os.path.exists(config_path):
        ...
        config = SparseMamba2DeltaASRConfig(
            ...
            threshold=_cfg(job_config, "threshold", 0.1),
